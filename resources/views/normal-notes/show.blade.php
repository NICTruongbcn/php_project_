...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex space-x-3">
                <form method="POST" action="{{ route('normal-notes.destroy', $note->id) }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('normal-notes.update-content', $note->id) }}" id="content-form" class="hidden">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea name="content" id="content" rows="15"
                          ...
                          placeholder="Write your note content here...">{{ old('content', $note->pages->first()->back_text ?? '') }}</textarea>
                @error('content')
        ...
        <div id="content-display">
            @if($note->pages->count() > 0 && $note->pages->first()->back_text)
                <div class="prose max-w-none">
                    {!! nl2br(e($note->pages->first()->back_text)) !!}
                </div>
            @else
